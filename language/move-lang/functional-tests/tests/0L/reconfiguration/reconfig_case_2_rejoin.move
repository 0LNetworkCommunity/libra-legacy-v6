...
script {
    ...
    fun main(sender: signer) {
        ...
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006001);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006002);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006003);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006004);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006005);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006014);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006015);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006016);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006017);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006018);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008006019);
    }
}
//check: EXECUTED
