...
script {
    ...
    fun main(sender: signer) {
        ...
        assert(Tower::get_count_in_epoch(@{{alice}}) == 5, 7357008015001);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Miner is the only one that can update their mining stats. Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008015002);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Miner is the only one that can update their mining stats. Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008015003);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Miner is the only one that can update their mining stats. Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::test_helper_get_count(&sender) == 5, 7357008015004);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        // Miner is the only one that can update their mining stats. Hence this first transaction.
        Tower::test_helper_mock_mining(&sender, 5);
        assert(Tower::get_count_in_epoch(@{{eve}}) == 5, 7357008015005);
    }
}
//check: EXECUTED
