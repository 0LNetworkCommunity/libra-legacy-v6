...
script {
    ...
    fun main(vm: signer) {
        ...
        assert(Tower::is_init(@0x3DC18D1CF61FAAC6AC70E3A63F062E4B), 7357000180105);

        Tower::test_helper_mock_mining_vm(vm, @{{alice}}, 20);
        Tower::test_helper_mock_mining_vm(vm, @{{bob}}, 20);
        Tower::test_helper_mock_mining_vm(vm, @{{carol}}, 20);
        Tower::test_helper_mock_mining_vm(vm, @{{dave}}, 20);
...
script {
    ...
    fun main(vm: signer) {
        ...
        Tower::test_helper_mock_mining_vm(vm, @{{carol}}, 20);
        Tower::test_helper_mock_mining_vm(vm, @{{dave}}, 20);
        Tower::test_helper_mock_mining_vm(vm, @0x3DC18D1CF61FAAC6AC70E3A63F062E4B, 20);
