...
script{
    ...
    fun main() {
        ...
        // valid signature, invalid pubkey, valid data, verify
...
/*
        ...
        assert(!EthSignature::verify(copy valid_signature, copy valid_pubkey, b"hello"), 1009);
*/
    }
}
