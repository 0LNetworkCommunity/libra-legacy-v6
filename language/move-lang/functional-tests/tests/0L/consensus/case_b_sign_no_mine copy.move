...
script {
    ...
    fun main(_sender: &signer) {
        ...
        Transaction::assert(MinerState::test_helper_get_height({{bob}}) == 0, 7357000180104);
        Transaction::assert(MinerState::test_helper_hash({{bob}}) == TestFixtures::alice_1_easy_chal(), 7357000180105);
        ...
        Transaction::assert(ValidatorUniverse::get_validator_weight({{bob}}) == 1, 7357000180106);  

        // MinerState::commit_state(sender, proof);
        Transaction::assert(MinerState::test_helper_get_height({{bob}}) == 1, 7357000180107);
    }
}
// check: EXECUTED
...
script {
    ...
    fun main(_account: &signer) {
        ...
        Transaction::assert(LibraSystem::is_validator({{bob}}) == true, 7357000180109);

        // TODO: this value should be == 1, since there was no mining.
        Transaction::assert(ValidatorUniverse::get_validator_weight({{bob}}) == 1, 7357000180110);  
    }
}