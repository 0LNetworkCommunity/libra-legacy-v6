...
//! account: dave, 9, 0, validator
//! account: eve, 10, 0, validator

// In this test there are 5 validators, they will be added to ValidatorUniverse
// We will mock the MinerState so that only one active validator {{alice}} is present
...
script {
    ...
    // Now lets check if the results are the same even in a larger N, N=4.
