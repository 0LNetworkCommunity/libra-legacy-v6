...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 4);
        assert(Tower::get_count_in_epoch(@{{bob}}) == 4, 7357300102011000);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 3);
        assert(Tower::get_count_in_epoch(@{{carol}}) == 3, 7357300103011000);
    }
}
//check: EXECUTED
...
script {
    ...
    fun main(sender: signer) {
        ...
        Tower::test_helper_mock_mining(&sender, 2);
        assert(Tower::get_count_in_epoch(@{{dave}}) == 2, 7357300104011000);
    }
}
//check: EXECUTED
