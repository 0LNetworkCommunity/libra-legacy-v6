...
fun main(sender: signer) {
  ...
  assert(DiemAccount::balance<GAS>(0xfa72817f1b5aab94658238ddcdc08010) == 1000000, 7357130101091000);
...
fun main(vm: signer) {
    ...
    assert(DiemAccount::balance<GAS>(0xfa72817f1b5aab94658238ddcdc08010) == old_account_bal_oper, 7357003);
