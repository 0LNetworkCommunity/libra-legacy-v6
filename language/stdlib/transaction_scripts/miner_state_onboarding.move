...
fun main(
  _challenge: vector<u8>,
  _solution: vector<u8>,
  _consensus_pubkey: vector<u8>,
  _validator_network_identity_pubkey: vector<u8>,
  _validator_network_address: vector<u8>,
  _full_node_network_identity_pubkey: vector<u8>,
  _full_node_network_address: vector<u8>,
...
//    assert(LibraAccount::balance<GAS::GAS>(parsed_address) == 0, 04);
