...
module LibraAccount {
    ...
    public fun make_payment<Token>(
        ...
        payee: address,
        amount: u64
    ) acquires LibraAccount, AccountOperationsCapability, Balance {
        assert(Signer::address_of(signer) == CoreAddresses::LIBRA_ROOT_ADDRESS(), 8001);
        ...
        deposit<Token>(payer, payee, coin, x"", x"");
    }
