address 0x0 {
    module ValidatorUniverse {
        ...
        public fun proposed_upcoming_validator_set_weights(addr: address, current_block_height: u64): u64 acquires ValidatorUniverse{
            ...
            // TODO: This is reusable. calculating the epoch start heights should be a public function.
            // Also dangrous to hard-code epoch_length here. Should be in Genesis.move
        ...
        // A gunction to get one validators proposed weight, based on Proof of Weight algorithm
        // for an upcoming Epoch.
