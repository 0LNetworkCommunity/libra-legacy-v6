...
use diem_transaction_builder::stdlib::{
    ...
    encode_Tower_commit_script_function
};
...
fn reconfig_bulk_update_test() {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
    // borrowed from Tower commit test, register the Tower for the new validators
    ...
    let payload = encode_Tower_commit_script_function(preimage, proof);
