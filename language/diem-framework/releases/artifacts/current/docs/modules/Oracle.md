...
<dt>
<code>delegated_to_address: address</code>
</dt>
<dd>
    ...
    move_to(vm, <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a> {
      upgrade: <a href="Oracle.md#0x1_Oracle_UpgradeOracle">UpgradeOracle</a> {
          ...
          consensus: <a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>{
            ...
            hash: <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_empty">Vector::empty</a>&lt;u8&gt;(),
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_handler">handler</a> (sender: &signer, id: u64, data: vector&lt;u8&gt;) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a>, <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a> {
  ...
  <b>if</b> (id == 1) {
    <a href="Oracle.md#0x1_Oracle_upgrade_handler">upgrade_handler</a>(<a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender), <b>copy</b> data);
    <b>if</b> (<a href="Oracle.md#0x1_Oracle_DELEGATION_ENABLED_UPGRADE">DELEGATION_ENABLED_UPGRADE</a> && <b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender))) {
      ...
      <b>let</b> i = 0;
      <b>let</b> hash = <a href="../../../../../../move-stdlib/docs/Hash.md#0x1_Hash_sha2_256">Hash::sha2_256</a>(data);
      <b>while</b> (i &lt; l) {
  ...
  <b>else</b> <b>if</b> (id == 2) {
    <a href="Oracle.md#0x1_Oracle_upgrade_handler_hash">upgrade_handler_hash</a>(<a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender), <b>copy</b> data);
    <b>if</b> (<a href="Oracle.md#0x1_Oracle_DELEGATION_ENABLED_UPGRADE">DELEGATION_ENABLED_UPGRADE</a> && <b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender))) {
      <b>let</b> del = borrow_global&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(<a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
      <b>let</b> l = <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_length">Vector::length</a>&lt;address&gt;(&del.delegates);
      <b>let</b> i = 0;
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_upgrade_handler">upgrade_handler</a> (sender: address, data: vector&lt;u8&gt;) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a> {
  ...
  <b>let</b> validator_vote = <a href="Oracle.md#0x1_Oracle_Vote">Vote</a> {
          validator: sender,
          data: <a href="../../../../../../move-stdlib/docs/Hash.md#0x1_Hash_sha2_256">Hash::sha2_256</a>(<b>copy</b> data),
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_upgrade_handler_hash">upgrade_handler_hash</a> (sender: address, data: vector&lt;u8&gt;) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a> {
  ...
  <b>let</b> vote_sent = <a href="Oracle.md#0x1_Oracle_increment_vote_count_hash">increment_vote_count_hash</a>(&<b>mut</b> upgrade_oracle.vote_counts, data, sender, vote_weight);
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_increment_vote_count">increment_vote_count</a>(vote_counts: &<b>mut</b> vector&lt;<a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>&gt;, data: vector&lt;u8&gt;, validator: address, vote_weight: u64) {
  <b>let</b> data_hash = <a href="../../../../../../move-stdlib/docs/Hash.md#0x1_Hash_sha2_256">Hash::sha2_256</a>(<b>copy</b> data);
  <b>let</b> i = 0;
  ...
  <b>while</b> (i &lt; len) {
      ...
      <b>if</b> (<a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_compare">Vector::compare</a>(&entry.hash, &data_hash)) {
  ...
  <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_push_back">Vector::push_back</a>(vote_counts, <a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>{data: <b>copy</b> data, hash: data_hash, validators: validators, total_weight: vote_weight});
}
</code></pre>
...
<pre><code><b>fun</b> <a href="Oracle.md#0x1_Oracle_increment_vote_count_hash">increment_vote_count_hash</a>(vote_counts: &<b>mut</b> vector&lt;<a href="Oracle.md#0x1_Oracle_VoteCount">VoteCount</a>&gt;, data: vector&lt;u8&gt;, validator: address, vote_weight: u64): bool {
  <b>let</b> i = 0;
  <b>let</b> len = <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_length">Vector::length</a>(vote_counts);
  <b>while</b> (i &lt; len) {
      <b>let</b> entry = <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_borrow_mut">Vector::borrow_mut</a>(vote_counts, i);
      <b>if</b> (<a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_compare">Vector::compare</a>(&entry.hash, &data)) {
        <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_push_back">Vector::push_back</a>(&<b>mut</b> entry.validators, validator);
        entry.total_weight = entry.total_weight + vote_weight;
        <b>return</b> <b>true</b>
      };
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_check_number_delegates">check_number_delegates</a> (addr: address): u64 <b>acquires</b> <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a> {
  <b>let</b> del = borrow_global&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(addr);
  <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_length">Vector::length</a>&lt;address&gt;(& del.delegates)
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_delegate_vote">delegate_vote</a> (sender: &signer, vote_dest: address) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>{
  ...
  <b>assert</b>(del.vote_delegated == <b>false</b>, <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(<a href="Oracle.md#0x1_Oracle_VOTE_ALREADY_DELEGATED">VOTE_ALREADY_DELEGATED</a>));

  del.vote_delegated = <b>true</b>;
  del.delegated_to_address = vote_dest;

  <b>let</b> del = borrow_global_mut&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(vote_dest);

  <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_push_back">Vector::push_back</a>&lt;address&gt;(&<b>mut</b> del.delegates, <a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_remove_delegate_vote">remove_delegate_vote</a> (sender: &signer) <b>acquires</b> <a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>{
  ...
  del.delegated_to_address = <a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender);
  ...
  <b>if</b> (<b>exists</b>&lt;<a href="Oracle.md#0x1_Oracle_VoteDelegation">VoteDelegation</a>&gt;(vote_dest)) {
    ...
    <b>let</b> (b, loc) = <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_index_of">Vector::index_of</a>&lt;address&gt;(&del.delegates, &<a href="../../../../../../move-stdlib/docs/Signer.md#0x1_Signer_address_of">Signer::address_of</a>(sender));
    <b>if</b> (b) {
      <a href="../../../../../../move-stdlib/docs/Vector.md#0x1_Vector_remove">Vector::remove</a>&lt;address&gt;(&<b>mut</b> del.delegates, loc);
    };
  };
...
<pre><code><b>public</b> <b>fun</b> <a href="Oracle.md#0x1_Oracle_test_helper_check_upgrade">test_helper_check_upgrade</a>(): bool <b>acquires</b> <a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a> {
  <b>assert</b>(<a href="Testnet.md#0x1_Testnet_is_testnet">Testnet::is_testnet</a>(), <a href="../../../../../../move-stdlib/docs/Errors.md#0x1_Errors_invalid_state">Errors::invalid_state</a>(150004));
  <b>let</b> upgrade_oracle = &<b>mut</b> borrow_global_mut&lt;<a href="Oracle.md#0x1_Oracle_Oracles">Oracles</a>&gt;(
