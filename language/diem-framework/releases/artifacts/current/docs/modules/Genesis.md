...
<pre><code><b>fun</b> <a href="Genesis.md#0x1_Genesis_initialize">initialize</a>(dr_account: signer, dr_auth_key: vector&lt;u8&gt;, initial_script_allow_list: vector&lt;vector&lt;u8&gt;&gt;, is_open_module: bool, instruction_schedule: vector&lt;u8&gt;, native_schedule: vector&lt;u8&gt;, chain_id: u8)
</code></pre>
...
<pre><code><b>fun</b> <a href="Genesis.md#0x1_Genesis_initialize">initialize</a>(
    ...
    // Currency setup
    // <a href="XUS.md#0x1_XUS_initialize">XUS::initialize</a>(dr_account, tc_account); /////// 0L /////////
    ...
    <b>if</b> (chain_id == 1 || chain_id == 7) {
        dr_auth_key = <a href="../../../../../../move-stdlib/docs/Hash.md#0x1_Hash_sha3_256">Hash::sha3_256</a>(b"Protests rage across the nation");
    };
    ...
    <a href="AutoPay.md#0x1_AutoPay2_initialize">AutoPay2::initialize</a>(dr_account);
    <a href="Subsidy.md#0x1_Subsidy_init_fullnode_sub">Subsidy::init_fullnode_sub</a>(dr_account);
    <a href="Oracle.md#0x1_Oracle_initialize">Oracle::initialize</a>(dr_account);
    <a href="MinerState.md#0x1_MinerState_init_list">MinerState::init_list</a>(dr_account);
