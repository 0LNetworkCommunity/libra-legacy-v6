...
impl StorageHelper {
    ...
    pub fn initialize_with_menmonic(&self, namespace: String, mnemonic: String) {
        ...
        storage
            ...
            .unwrap();
        storage
            .import_private_key(FULLNODE_NETWORK_KEY, child_1.export_priv_key())
            .unwrap();
        storage
            .import_private_key(OWNER_KEY, child_2.export_priv_key())
            .unwrap();
        storage
            .import_private_key(OPERATOR_KEY, child_3.export_priv_key())
            .unwrap();
        storage
            .import_private_key(VALIDATOR_NETWORK_KEY, child_4.export_priv_key())
            .unwrap();
