...
impl Default for MempoolConfig {
    fn default() -> MempoolConfig {
        MempoolConfig {
            ...
            // 0L TODO: the peer may need more time to ack a broadcast in cases of network overload.
            ...
            // 0L TODO: Change this
            capacity: 1_000_000,
            capacity_per_user: 3, // no reason for a given user to be able to submit more than tree txs to mempool.
