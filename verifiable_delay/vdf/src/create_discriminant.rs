...
//! Instead, it generates the discriminant from a (much smaller) seed.  This
//! file implements this process.  The table of precomputed constants used is
//! generated by `build.rs`.
include!(concat!(env!("OUT_DIR"), "/constants.rs"));

use super::gmp_classgroup::ffi::{mpz_rem_u16, mpz_rem_u32};
use gmp::mpz::Mpz;
