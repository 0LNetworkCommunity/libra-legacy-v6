...
web-files: 
	curl -L --progress-bar --create-dirs -o ${DATA_PATH}/web-monitor.zip https://github.com/OLSF/libra/releases/latest/download/web-monitor.tar.gz
	unzip ${DATA_PATH}/web-monitor.tar.gz -d ${DATA_PATH}/web-monitor
