...
impl Method {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            //////// 0L ////////
            // Name is not used in json RPC, only for errors, what matters 
            // is the type name, which serde formats as snakecase.
            Method::GetTowerStateView => "get_miner_state_view",
