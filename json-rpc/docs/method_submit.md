...
|-------|----------|------------------------------------------------------------------------------------------------------|
| data  | string   | Signed transaction data - hex-encoded bytes of [LCS][1] serialized Diem [SignedTransaction][3] type.|

Steps to create "data" parameters:

1. Create [RawTransaction][2]
2. Create signing message:
   1. [SHA3](https://en.wikipedia.org/wiki/SHA-3) hash bytes of string "LIBRA::RawTransaction".
   2. [RawTransaction][2] [LCS][1] serialized bytes.
...
[2]: https://developers.diem.org/docs/rustdocs/diem_types/transaction/struct.RawTransaction.html "RawTransaction"
[3]: https://developers.diem.org/docs/rustdocs/diem_types/transaction/struct.SignedTransaction.html "SignedTransaction"
