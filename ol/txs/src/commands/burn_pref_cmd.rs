...
pub struct BurnPrefCmd {
    #[options(short = "c", help = "whenever there is a burn, send to community wallet index instead.")]
    community: bool,
    ...
    fn run(&self) {
        ...
        match set_burn_prefs(
          ...
          entry_args.save_path
            ...
            Ok(_) => {
              println!("Success: submitted burn preferences, community option: {}", !self.burn);
            },
            Err(e) => {
              println!("ERROR: could not submit burn preferences transaction, message: \n{:?}", &e);
              exit(1);
            },
        }
    }
