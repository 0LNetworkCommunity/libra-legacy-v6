...
reverse-rename:
# Module rename
	mv ${SOURCE_PATH}/language/diem-framework/modules/0L/Upgrade.move language/diem-framework/modules/0L/Upgrade.move.e2e
	mv ${SOURCE_PATH}/language/diem-framework/modules/0L/Upgrade.move.temp language/diem-framework/modules/0L/Upgrade.move
