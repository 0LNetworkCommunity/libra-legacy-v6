...
pub struct OLLegacyAccountState(BTreeMap<Vec<u8>, Vec<u8>>);

impl OLLegacyAccountState {
...
impl fmt::Debug for OLLegacyAccountState {
...
impl TryFrom<(&AccountResource, &BalanceResource)> for OLLegacyAccountState {
    type Error = Error;
    ...
    fn try_from(
        ...
        btree_map.insert(
            OLLegacyAccountResource::resource_path(),
