...
script {
  ...
  fun main(vm: signer, _: signer) {
    ...
    // eve did not mine or validator in last epoch, case != 1. So there wont
    // be a reward.There is a cost-to-exist but since Eve's balance is below
    // the cost, it will not be deducted.
