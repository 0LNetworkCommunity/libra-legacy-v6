...
<pre><code><b>fun</b> <a href="DonorDirected.md#0x1_DonorDirected_schedule">schedule</a>(multisig_address: <b>address</b>, payee: <b>address</b>, value: u64, description: vector&lt;u8&gt;): u64
</code></pre>
...
<pre><code><b>fun</b> <a href="DonorDirected.md#0x1_DonorDirected_schedule">schedule</a>(
  multisig_address: <b>address</b>, payee: <b>address</b>, value: u64, description: vector&lt;u8&gt;
...
<pre><code><b>public</b> <b>fun</b> <a href="DonorDirected.md#0x1_DonorDirected_new_timed_transfer_multisig">new_timed_transfer_multisig</a>(
  ...
  <b>let</b> (passed, opt) = <a href="MultiSig.md#0x1_MultiSig_propose">MultiSig::propose</a>&lt;<a href="DonorDirected.md#0x1_DonorDirected_DonorDirectedProp">DonorDirectedProp</a>&gt;(sender, multisig_address, p, <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Option.md#0x1_Option_none">Option::none</a>());
  <a href="MultiSig.md#0x1_MultiSig_maybe_restore_withdraw_cap">MultiSig::maybe_restore_withdraw_cap</a>(sender, multisig_address, opt);
  <b>if</b> (passed) {
    <b>return</b> <a href="../../../../../../../DPN/releases/artifacts/current/build/MoveStdlib/docs/Option.md#0x1_Option_some">Option::some</a>(<a href="DonorDirected.md#0x1_DonorDirected_schedule">schedule</a>(multisig_address, payee, value, description))
  };
