...
* Move modules:
    * We will build modules that:
        ...
        * Track the supply of Diem coins in the system and allow the association to mint and burn Diem coins to keep the supply synchronized with the real-world reserve assets.
